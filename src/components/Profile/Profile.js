...
import { delPost as delPostPosts} from '../../store/slices/posts/postsSlices';
import { delPost as delPostsUsers, selectUsers } from '../../store/slices/users/usersSlice';
import './Profile.css'
const Profile = () => {
            ...
            <div className="gallery">
        {
            currentUser?.posts.map(el => (
                <div key={el.id} className="gallery-item">
                    <img
                     src={el.img} className="gallery-image" alt=""/>
                    <div className="gallery-item-info">
                        <span
                            onClick={()=> {dispatch(delPostPosts(el.id)); dispatch(delPostsUsers(el.id))} }
                            className='delItem'
                        >X</span>
                        <ul>
